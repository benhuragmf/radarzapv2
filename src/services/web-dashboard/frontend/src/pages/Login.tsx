...
import { loginWithDiscord, loginWithGoogle } from '../lib/auth'
...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  google_redirect_mismatch:
    'Redirect URI incorreto no Google Cloud Console. Cadastre https://app.radarchat.com.br/auth/google/callback',
  google_account_conflict:
    'Não foi possível criar conta Google (conflito no banco). Reinicie o backend ou contate suporte.',
  ...
  return (
    <div className="rz-auth-shell">
      ...
      <main className="rz-auth-main">
        <div className="rz-auth-main-inner">
          <div className="rz-auth-mobile-brand lg:hidden">
            <AuthBrand subtitle="Painel administrativo" />
          </div>
          ...
          <div className="rz-auth-card">
            ...
            <div className="rz-auth-providers">
              ...
              <div className="rz-auth-divider" role="presentation">
                <span>ou</span>
              </div>
