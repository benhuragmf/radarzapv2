  ...
  return (
    <DiscordPage description="Configurações e permissões do servidor selecionado na barra lateral.">
      <Card className="space-y-4">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            <p className="text-xs text-gray-500">Servidor Discord</p>
            <p className="text-lg font-semibold text-white truncate">{guildName}</p>
            <p className="text-xs text-gray-500 font-mono mt-0.5">{guildId}</p>
          </div>
        </div>
        ...
        {membership && (
          <>
            <div>
              <p className="text-xs text-gray-500">Seu papel neste servidor</p>
              <p className="text-sm font-medium mt-0.5">{membership.role}</p>
              <Badge
            ...
            <div>
              <p className="text-xs text-gray-500">Papel efetivo no RadarZap</p>
              <p className="text-sm">{membership.effectiveRole.replace('_', ' ')}</p>
            </div>
          </>
        )}
      ...
      <Card className="space-y-2">
        <p className="text-sm font-medium text-white">Conta RadarZap</p>
