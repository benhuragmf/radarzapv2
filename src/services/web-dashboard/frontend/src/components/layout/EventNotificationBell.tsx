  ...
  return (
    <div className="relative">
      ...
      >
        <Bell size={15} />
        {unreadCount > 0 && (
          <span className="absolute -top-1 -right-1 min-w-[16px] h-4 px-1 rounded-full bg-amber-500 text-[10px] font-bold text-[var(--rz-on-accent)] flex items-center justify-center">
