...
export const TENANT_PLATFORM_NAV: NavEntry[] = [
  ...
  group('grp-inbox-ai', 'IA de Atendimento', Sparkles, [
    ...
    link('inbox-ai-empresa', 'Empresa e IA', Store, '/platform/inbox/ia#empresa', 'inbox:ai:manage'),
...
export const ROUTE_PERMISSIONS: Record<string, string> = {
  ...
  '/platform/produtos': 'inbox:ai:manage',
  '/platform/produtos#visao': 'inbox:ai:manage',
  '/platform/produtos#itens': 'inbox:ai:manage',
  '/platform/produtos#pedidos': 'orders:view',
  '/platform/produtos#comprovantes': 'orders:view',
  '/platform/produtos#entrega': 'inbox:ai:manage',
  '/platform/produtos#configuracoes': 'inbox:ai:manage',
...
export const PAGE_TITLES: Record<string, string> = {
  ...
  '/platform/inbox/ia#empresa': 'Empresa e IA',
  '/platform/inbox/ia#coleta': 'Dados a coletar',
  '/platform/inbox/ia#kb': 'Base de conhecimento',
  '/platform/inbox/ia#testar': 'Testar IA',
  '/platform/produtos': 'Produtos',
  '/platform/produtos#visao': 'Produtos — Visão geral',
  '/platform/produtos#itens': 'Produtos e estoque',
  '/platform/produtos#pedidos': 'Pedidos',
  '/platform/produtos#comprovantes': 'Comprovantes PIX',
  '/platform/produtos#entrega': 'Entrega e frete',
  '/platform/produtos#configuracoes': 'Configurações de produtos',
