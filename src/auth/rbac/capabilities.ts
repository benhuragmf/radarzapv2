...
export const Cap = {
  ...
  ORDERS_APPROVE_PAYMENT: 'orders:approve-payment',
  ORDERS_REJECT_PAYMENT: 'orders:reject-payment',
  ORDERS_RESEND_PIX_NOTIFICATION: 'orders:resend-pix-notification',
  ORDERS_VIEW_PAYMENT_PROOF: 'orders:view-payment-proof',
  ORDERS_UPDATE_STATUS: 'orders:update-status',
  ORDERS_ADD_INTERNAL_NOTE: 'orders:add-internal-note',
  COMPANY_SALES_CONFIG_READ: 'company:sales-config:read',
  COMPANY_SALES_CONFIG_UPDATE: 'company:sales-config:update',
...
const COMPANY_OWNER_CAPS: Capability[] = [
  ...
  Cap.COMPANY_SALES_CONFIG_READ,
  Cap.COMPANY_SALES_CONFIG_UPDATE,
  Cap.ORDERS_VIEW,
  Cap.ORDERS_APPROVE_PAYMENT,
  Cap.ORDERS_REJECT_PAYMENT,
  Cap.ORDERS_RESEND_PIX_NOTIFICATION,
  Cap.ORDERS_VIEW_PAYMENT_PROOF,
  Cap.ORDERS_UPDATE_STATUS,
  Cap.ORDERS_ADD_INTERNAL_NOTE,
  Cap.WEBCHAT_VIEW,
  Cap.WEBCHAT_REPLY,
  Cap.WEBCHAT_MANAGE,
