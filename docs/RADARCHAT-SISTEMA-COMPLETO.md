...
O Radar Chat é uma plataforma SaaS multi-tenant para **atendimento omnicanal** (WhatsApp Baileys, WebChat, formulários de leads), **automação** (campanhas, regras, Discord→WhatsApp opcional), **Inbox** com filas/setores, **tickets** (`TK-…`), **IA** (Básica e Premium), **equipe/RBAC**, **consentimento LGPD** e **API REST** (`/api`, `X-API-Key`).
...
- Regra Cursor: `.cursor/rules/radarchat-v2-system-registry.mdc`.
...
Matriz oficial TOP 03: [`top/RADARCHAT-TOP-03-PLANOS-MENSALIDADES-LIMITES.md`](./concluidos/top/RADARCHAT-TOP-03-PLANOS-MENSALIDADES-LIMITES.md).
...
Documento: [`EQUIPE-RBAC.md`](./EQUIPE-RBAC.md). Auditoria TOP 04: [`top/RADARCHAT-TOP-04-RBAC-PERMISSOES-EQUIPE-SEGURANCA.md`](./concluidos/top/RADARCHAT-TOP-04-RBAC-PERMISSOES-EQUIPE-SEGURANCA.md).
...
TOP 05: [`top/RADARCHAT-TOP-05-STATUS-PRESENCA-FILA.md`](./concluidos/top/RADARCHAT-TOP-05-STATUS-PRESENCA-FILA.md).
...
Consolidado: [`RADARCHAT-MODOS-ATENDIMENTO-IMPLEMENTACAO.md`](./RADARCHAT-MODOS-ATENDIMENTO-IMPLEMENTACAO.md). TOP 06: [`top/RADARCHAT-TOP-06-MODOS-ATENDIMENTO.md`](./concluidos/top/RADARCHAT-TOP-06-MODOS-ATENDIMENTO.md).
...
[`INBOX-ATENDIMENTO.md`](./INBOX-ATENDIMENTO.md). TOP 07: [`top/RADARCHAT-TOP-07-INBOX-CONVERSAS-FILA-TRANSFERENCIA.md`](./concluidos/top/RADARCHAT-TOP-07-INBOX-CONVERSAS-FILA-TRANSFERENCIA.md).
...
[`TICKET-ATENDIMENTO.md`](./TICKET-ATENDIMENTO.md). TOP 08: [`top/RADARCHAT-TOP-08-TICKETS-CHAMADOS-TK-RASTREABILIDADE.md`](./concluidos/top/RADARCHAT-TOP-08-TICKETS-CHAMADOS-TK-RASTREABILIDADE.md).
...
[`LEADS-FORMULARIO.md`](./LEADS-FORMULARIO.md). TOP 09: [`top/RADARCHAT-TOP-09-CONTATOS-LEADS-KANBAN-DEDUPLICACAO.md`](./concluidos/top/RADARCHAT-TOP-09-CONTATOS-LEADS-KANBAN-DEDUPLICACAO.md).
...
TOP 10: [`top/RADARCHAT-TOP-10-FORMULARIOS-PUBLICOS-EMBED-CAPTURA-LEADS.md`](./concluidos/top/RADARCHAT-TOP-10-FORMULARIOS-PUBLICOS-EMBED-CAPTURA-LEADS.md).
...
[`WEBCHAT.md`](./WEBCHAT.md). TOP 11: [`top/RADARCHAT-TOP-11-WEBCHAT-WIDGET-FALLBACK-EXPERIENCIA.md`](./concluidos/top/RADARCHAT-TOP-11-WEBCHAT-WIDGET-FALLBACK-EXPERIENCIA.md).
...
TOP 12: [`top/RADARCHAT-TOP-12-WHATSAPP-SESSAO-QR-RECONEXAO-COMANDOS.md`](./concluidos/top/RADARCHAT-TOP-12-WHATSAPP-SESSAO-QR-RECONEXAO-COMANDOS.md).
...
**Pendente:** QR real, sessão real, inbound/outbound e comandos em ambiente final — **QA manual TOP 20 bloco D** ([`top/RADARCHAT-TOP-20-CONGELAMENTO-FINAL-GO-LIVE-CONTROLADO.md`](./concluidos/top/RADARCHAT-TOP-20-CONGELAMENTO-FINAL-GO-LIVE-CONTROLADO.md)).
...
TOP 13: [`top/RADARCHAT-TOP-13-BRIDGE-WEBCHAT-WHATSAPP.md`](./concluidos/top/RADARCHAT-TOP-13-BRIDGE-WEBCHAT-WHATSAPP.md). QA manual: [`QA-WEBCHAT-WA-FALLBACK-BRIDGE.md`](./QA-WEBCHAT-WA-FALLBACK-BRIDGE.md).
...
TOP 14: [`top/RADARCHAT-TOP-14-IA-BASICA-TRIAGEM-ENCAMINHAMENTO.md`](./concluidos/top/RADARCHAT-TOP-14-IA-BASICA-TRIAGEM-ENCAMINHAMENTO.md).
...
Doc detalhada: [`top/RADARCHAT-TOP-15-IA-PREMIUM-KB-HANDOFF.md`](./concluidos/top/RADARCHAT-TOP-15-IA-PREMIUM-KB-HANDOFF.md). Créditos: [`IA-CREDITOS-E-CARTEIRA.md`](./IA-CREDITOS-E-CARTEIRA.md).

---

## 19. IA Créditos e carteira

Proteção **anti-prejuízo** para LLM Radar Chat: saldo mensal por plano + `purchasedCredits` − consumo proporcional ao custo real (`AiUsage` / `creditWeight`).
...
**Gate:** `canConsumeAiCredits` / `getUsageSnapshot` antes de `AiProviderService.complete`; chave própria (`mode: company`) não debita carteira Radar Chat.

**Consome:** IA Básica LLM fallback, IA Premium LLM Radar Chat. **Não consome:** robotizado, triagem local, FAQ/auto-resolve local, handoff, bridge.
...
Doc: [`IA-CREDITOS-E-CARTEIRA.md`](./IA-CREDITOS-E-CARTEIRA.md), [`top/RADARCHAT-TOP-16-IA-CREDITOS-CARTEIRA-CONSUMO-FALLBACK.md`](./concluidos/top/RADARCHAT-TOP-16-IA-CREDITOS-CARTEIRA-CONSUMO-FALLBACK.md).

---

## 20. Billing, assinaturas e bloqueios

[`BILLING.md`](./BILLING.md) · [`top/RADARCHAT-TOP-17-BILLING-ASSINATURAS-LIMITES-BLOQUEIOS.md`](./concluidos/top/RADARCHAT-TOP-17-BILLING-ASSINATURAS-LIMITES-BLOQUEIOS.md).
...
[`top/RADARCHAT-TOP-18-AUDITORIA-SEGURANCA-LGPD-HARDENING.md`](./concluidos/top/RADARCHAT-TOP-18-AUDITORIA-SEGURANCA-LGPD-HARDENING.md) · [`CONSENTIMENTO-LGPD.md`](./CONSENTIMENTO-LGPD.md) · [`WEBHOOKS.md`](./WEBHOOKS.md).
...
- **Admin ops (2.12.37–2.12.63):** `GET /api/admin/ops/summary`, orgs, security-events; UI `/admin/dashboard` (8 abas); portal LGPD; bridge dedup. **Auditoria horizontal:** [`concluidos/RADARCHAT-AUDITORIA-HORIZONTAL-SEGURANCA-ESTABILIDADE.md`](./concluidos/RADARCHAT-AUDITORIA-HORIZONTAL-SEGURANCA-ESTABILIDADE.md). Docs: [`concluidos/admin/RADARCHAT-ADMIN-DASHBOARD-OPS.md`](./concluidos/admin/RADARCHAT-ADMIN-DASHBOARD-OPS.md), série arquivada em [`concluidos/admin/`](./concluidos/admin/).
...
**Versão ref.:** `2.12.5` (TOP 19) · Doc completo: [`top/RADARCHAT-TOP-19-QA-FINAL-REGRESSAO-GO-LIVE.md`](./concluidos/top/RADARCHAT-TOP-19-QA-FINAL-REGRESSAO-GO-LIVE.md)
...
| Doc | Conteúdo |
|-----|----------|
| [`top/RADARCHAT-TOP-20-CONGELAMENTO-FINAL-GO-LIVE-CONTROLADO.md`](./concluidos/top/RADARCHAT-TOP-20-CONGELAMENTO-FINAL-GO-LIVE-CONTROLADO.md) | Congelamento, checklists produção, QA manual A–J |
| [`RADARCHAT-RESULTADO-FINAL-TOP-01-20.md`](./concluidos/RADARCHAT-RESULTADO-FINAL-TOP-01-20.md) | Leitura rápida pós 20 TOPs |
...
> **Preservação:** arquivos em `docs/concluidos/top/RADARCHAT-TOP-NN-*.md` (auditoria). Índice: [`INDICE-DOCUMENTACAO.md`](./INDICE-DOCUMENTACAO.md) · [`concluidos/top/RADARCHAT-TOP-21-DOCUMENTACAO-FINAL-UNICA-ORGANIZACAO.md`](./concluidos/top/RADARCHAT-TOP-21-DOCUMENTACAO-FINAL-UNICA-ORGANIZACAO.md).

| # | Tema | Doc | Versão ref. | Status |
|---|------|-----|-------------|--------|
| 01 | Diagnóstico | `top/RADARCHAT-TOP-01-*` | — | Concluído |
...
Fonte detalhada: [`top/RADARCHAT-TOP-20-CONGELAMENTO-FINAL-GO-LIVE-CONTROLADO.md`](./concluidos/top/RADARCHAT-TOP-20-CONGELAMENTO-FINAL-GO-LIVE-CONTROLADO.md) § Pendências finais.
...
2. Comparar com v1 apenas se necessário: `.cursor/rules/radarchat-v2-reference.mdc`.
