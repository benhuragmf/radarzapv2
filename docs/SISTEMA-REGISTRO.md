...
**Versão atual:** `2.17.60` (`package.json`) · **Última revisão doc:** 2026-07-01
...
|--------|------------------|
| **2.17.60** | Endereço Entrega v1: normalizador, confirmação, snapshot, frete seguro — **local** (`RADARCHAT-ENDERECO-ENTREGA-V1-2.17.60.md`) |
