...
**Versão atual:** `2.17.13` (`package.json`) · **Última revisão doc:** 2026-06-30
...
|--------|------------------|
| **2.17.13** | Onboarding vertical: memórias IA, ADMIN aplica, OpenAPI, doc `ONBOARDING-VERTICAL.md`, testes integração |
