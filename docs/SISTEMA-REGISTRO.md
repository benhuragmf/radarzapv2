...
**Versão atual:** `2.12.37` (`package.json`) · **Última revisão doc:** 2026-06-27
...
| **2.12.2** | TOP 16: IA Créditos/carteira/consumo/fallback — `docs/top/RADARZAP-TOP-16-IA-CREDITOS-CARTEIRA-CONSUMO-FALLBACK.md` |
| **2.12.1** | TOP 15: IA Premium/KB/handoff — `docs/top/RADARZAP-TOP-15-IA-PREMIUM-KB-HANDOFF.md` |
| **2.12.0** | TOP 14: IA Básica/triagem/encaminhamento — `docs/top/RADARZAP-TOP-14-IA-BASICA-TRIAGEM-ENCAMINHAMENTO.md` |
| **2.11.99** | TOP 13: Bridge WebChat↔WhatsApp — `docs/top/RADARZAP-TOP-13-BRIDGE-WEBCHAT-WHATSAPP.md` |
| **2.11.98** | TOP 12: WhatsApp/sessão/QR/reconexão/comandos + doc mestre — `docs/top/RADARZAP-TOP-12-WHATSAPP-SESSAO-QR-RECONEXAO-COMANDOS.md`, `docs/RADARZAP-SISTEMA-COMPLETO.md` |
| **2.11.97** | TOP 11: WebChat/widget/fallback/experiência visitante — `docs/top/RADARZAP-TOP-11-WEBCHAT-WIDGET-FALLBACK-EXPERIENCIA.md` |
| **2.11.96** | TOP 10: formulários públicos/embed/captura — `docs/top/RADARZAP-TOP-10-FORMULARIOS-PUBLICOS-EMBED-CAPTURA-LEADS.md` |
| **2.11.95** | TOP 09: contatos/leads/Kanban/deduplicação — `docs/top/RADARZAP-TOP-09-CONTATOS-LEADS-KANBAN-DEDUPLICACAO.md` |
| **2.11.94** | TOP 08: tickets/chamados TK, token público, SLA, rastreabilidade — `docs/top/RADARZAP-TOP-08-TICKETS-CHAMADOS-TK-RASTREABILIDADE.md` |
