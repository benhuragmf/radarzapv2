# RadarZap — Inventário páginas `/admin/*`

**Versão:** `2.12.44` · **Atualizado:** 2026-06-27  
**Escopo:** todas as rotas staff interno (aba Admin RadarZap + Moderador)
...
Ver também: [`RADARZAP-ADMIN-DASHBOARD-OPS-ETAPA-9-AUDITORIA-ROTAS.md`](./RADARZAP-ADMIN-DASHBOARD-OPS-ETAPA-9-AUDITORIA-ROTAS.md).
