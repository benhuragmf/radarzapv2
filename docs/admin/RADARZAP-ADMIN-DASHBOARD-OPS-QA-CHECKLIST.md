# RadarZap — Admin Dashboard Ops — QA Checklist

**Versão alvo:** `2.12.41` · **Rota:** `/admin/dashboard` · **Responsável QA manual:** Benhur

Marcar `[x]` após validar localmente. Anotar bugs em [`RADARZAP-ADMIN-DASHBOARD-OPS-QA-RESULTADO.md`](./RADARZAP-ADMIN-DASHBOARD-OPS-QA-RESULTADO.md).
...
- API: [`RADARZAP-ADMIN-DASHBOARD-OPS-API.md`](./RADARZAP-ADMIN-DASHBOARD-OPS-API.md)
- Módulo: [`RADARZAP-ADMIN-DASHBOARD-OPS.md`](./RADARZAP-ADMIN-DASHBOARD-OPS.md)
