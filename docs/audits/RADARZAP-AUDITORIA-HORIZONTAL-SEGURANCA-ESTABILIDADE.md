...
| ID | Sev | Área | Descrição |
|----|-----|------|-----------|
| **AH-S01** | **CRÍTICO** | Boot | Mongo + Redis obrigatórios — sem degraded mode — **✅ 2.12.56 runbook** |
...
| **Corrigir agora?** | ✅ **2.12.56** — runbook `docs/operacao/RUNBOOK-SPOF-MONGO-REDIS.md`; degraded mode código ⏳ pós Fase 1 |
...
| AH-D04 | Portal LGPD pendente | ⏳ backlog TOP 18 |
| AH-M05 | Bridge dedup multi-réplica futuro | ⏳ pós go-live |
...
- AH-S01 degraded mode **código** — pós Fase 1 (runbook ✅ 2.12.56)
- AH-D04 portal LGPD self-service — TOP 18 backlog
- AH-M05 bridge dedup Redis multi-réplica — pós go-live
...
| 6 | QA manual VPS Etapa 10 | ⏳ humano |
| 7 | Bloco E browser VPS + AuditLog | ⏳ humano |
...
**Próximo passo recomendado:** QA manual VPS (Benhur); `npm run pre-push:gate` antes de commit/push; backlog AH-D04 / AH-M05 pós Fase 1.
