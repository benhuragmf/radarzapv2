# RadarZap — TOP 18/20 — Auditoria, Segurança, LGPD e Hardening
...
| Outbound RadarZap | HMAC `X-RadarZap-Signature` | Fila BullMQ | Sim |
...
`docs/RADARZAP-SISTEMA-COMPLETO.md` §21, CHANGELOG, INDICE, SISTEMA-REGISTRO, README.
