# RadarZap — TOP 02/20 — Governança, Baseline e Gates Obrigatórios
...
| `.cursor/rules/radarzap-v2-system-registry.mdc` | Espelho 2.11.88 |
...
docs/top/RADARZAP-TOP-01-DIAGNOSTICO-INICIAL.md (novo, TOP 01)
docs/top/RADARZAP-TOP-02-GOVERNANCA-BASELINE-GATES.md (este arquivo)
package.json
