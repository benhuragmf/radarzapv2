# RadarZap — Plano de upgrades (21 épicos)

**Criado:** 2026-06-27  
**Versão ref produto:** `2.12.6`  
**Base de análise:** [`RADARZAP-SISTEMA-COMPLETO.md`](./RADARZAP-SISTEMA-COMPLETO.md), TOPs 01–21, [`RADARZAP-VISAO-PRODUTO-DIFERENCIACAO.md`](./concluidos/RADARZAP-VISAO-PRODUTO-DIFERENCIACAO.md), [`referencias/REFERENCIAS-MERCADO-UPGRADES.md`](./referencias/REFERENCIAS-MERCADO-UPGRADES.md)
...
**Gap hoje:** Gates automatizados verdes (772 testes); **QA manual A–J pendente**; VPS/SSL/deploy não executados ([`top/RADARZAP-TOP-20`](./top/RADARZAP-TOP-20-CONGELAMENTO-FINAL-GO-LIVE-CONTROLADO.md)).
...
- [ ] Status em [`RADARZAP-SISTEMA-COMPLETO.md`](./RADARZAP-SISTEMA-COMPLETO.md): `PRONTO PARA GO-LIVE CONTROLADO` ou lista de bloqueios
...
**Gap hoje:** `lead-stage.util.ts` + Kanban leads existem; `Destination.commercialStatus` existe no modelo; **não há** funil unificado na UI Inbox, nem sync automático conversa→estágio, nem valor estimado/motivo perda padronizado ([`RADARZAP-VISAO-PRODUTO` §3.7](./concluidos/RADARZAP-VISAO-PRODUTO-DIFERENCIACAO.md)).
...
- [ ] Gate: `inbox:ai:manage` ou `inbox:view`; consome créditos IA se LLM RadarZap (mesmo meter TOP 16)
...
**Objetivo:** Nova org configura RadarZap em **< 15 min** sem suporte: widget, WA, equipe, modo atendimento, teste.
...
#### Documentação
- [ ] [`RADARZAP-VISAO-PRODUTO` §3.10](./concluidos/RADARZAP-VISAO-PRODUTO-DIFERENCIACAO.md)
- [ ] [`MENU-PAGES-REGISTRY.md`](./MENU-PAGES-REGISTRY.md)
...
- [ ] Doc [`RADARZAP-VISAO-PRODUTO` §3.8](./concluidos/RADARZAP-VISAO-PRODUTO-DIFERENCIACAO.md)
...
### Entregáveis completos
- [ ] Página pública `status.radarzap.com.br` (ou `/status`)
