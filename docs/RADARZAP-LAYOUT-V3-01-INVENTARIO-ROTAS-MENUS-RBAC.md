# RadarZap Layout v3 01 — Inventário de Rotas, Menus e RBAC

## 1. Objetivo

Este arquivo mapeia rotas, menus e permissões antes de qualquer alteração visual no RadarZap Layout v3. A meta é registrar o estado real do painel para que as próximas fases possam reorganizar navegação e linguagem sem quebrar RBAC, redirects, deep links, atendimento, WhatsApp, WebChat, IA ou billing.
...
| Arquivos já não versionados antes da etapa | `data/`, `mocker/modelochat/`, `docs/RADARZAP-UX-VISUAL-01-DIAGNOSTICO-GERAL.md`, `docs/RADARZAP-UX-VISUAL-02-NOVA-ORGANIZACAO-E-CONCEITO.md`, `docs/RADARZAP-UX-VISUAL-03-PLANO-DE-EXECUCAO-E-QA.md` |
| Arquivos criados nesta etapa | Este arquivo e os demais `RADARZAP-LAYOUT-V3-0*.md` |
...
| Tipo | Arquivos |
|------|----------|
| Docs UX base | `docs/RADARZAP-UX-VISUAL-01-DIAGNOSTICO-GERAL.md`, `docs/RADARZAP-UX-VISUAL-02-NOVA-ORGANIZACAO-E-CONCEITO.md`, `docs/RADARZAP-UX-VISUAL-03-PLANO-DE-EXECUCAO-E-QA.md` |
...
O menu Discord existe como aba separada quando o usuário tem acesso Discord ou é staff. Ele deve permanecer isolado da operação principal RadarZap para não misturar automação Discord -> WhatsApp com atendimento WhatsApp/WebChat.
