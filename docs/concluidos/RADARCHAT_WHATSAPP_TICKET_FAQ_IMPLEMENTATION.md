# Radar Chat — Implementação: consulta de ticket + FAQ + fallback WA
...
- Checklist de QA atualizado em `RADARCHAT_WHATSAPP_TICKET_FAQ_AUDIT.md` §10.
...
- QA manual completo (checklist em `RADARCHAT_WHATSAPP_TICKET_FAQ_AUDIT.md` §10 e **`../QA-WEBCHAT-WA-FALLBACK-BRIDGE.md`**).
