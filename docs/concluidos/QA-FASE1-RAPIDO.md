...
> **Arquivo.** Substituído por [`RADARCHAT-QA-HUMANO-REAL-CHECKLIST-COMPLETO-2.17.61.md`](../RADARCHAT-QA-HUMANO-REAL-CHECKLIST-COMPLETO-2.17.61.md) (Partes A–E).
...
Abrir **`http://localhost:3001/leads/preview.html`** ou use **Contatos → Leads → Integrar no site** no painel.
