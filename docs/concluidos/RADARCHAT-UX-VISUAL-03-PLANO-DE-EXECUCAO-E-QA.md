# Radar Chat UX Visual 03 — Plano de Execução e QA

> **Arquivo — planejamento Layout v3.** Substituído por [`RADARCHAT-LAYOUT-V3-09-FASE-4-5-QA-VISUAL-NAVEGAVEL.md`](../RADARCHAT-LAYOUT-V3-09-FASE-4-5-QA-VISUAL-NAVEGAVEL.md).

## 1. Objetivo

Criar um plano em etapas para melhorar a organização visual do Radar Chat sem quebrar funcionalidades existentes, preservando rotas, RBAC, fluxos de atendimento, billing, IA, dados e integrações.
...
- Não quebrar RBAC.
- Não misturar Radar Chat com outros projetos.
...
Desenvolvedor/dono do Radar Chat:
