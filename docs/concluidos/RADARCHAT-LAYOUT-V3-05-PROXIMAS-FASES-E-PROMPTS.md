# Radar Chat Layout v3 05 — Próximas Fases e Prompts

> **Arquivo — planejamento.** Fases 2–4.5 executadas: [`RADARCHAT-LAYOUT-V3-06`](../RADARCHAT-LAYOUT-V3-06-FASE-2-MENU-E-NAVEGACAO.md) … [`09`](../RADARCHAT-LAYOUT-V3-09-FASE-4-5-QA-VISUAL-NAVEGAVEL.md).

## 1. Objetivo

Registrar os próximos prompts de execução visual do Radar Chat sem executar nenhuma mudança nesta etapa. Cada fase deve preservar rotas, RBAC, atendimento, WhatsApp, WebChat, IA, billing, dados e documentação.
...
10. Fase 11 — Revisão final 100% Radar Chat.
...
```text
Você é o Codex no Radar Chat v2, branch layout-v3.
...
```text
Executar Fase 3 — Header operacional no Radar Chat, branch layout-v3.
...
```text
Executar Fase 11 — Revisão final 100% Radar Chat.
