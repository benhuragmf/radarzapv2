# Radar Chat — Modos de atendimento (Fase 3)

**Versão:** 2.10.107 · **Data:** 2026-06-19

Continuação de [`RADARCHAT-ATTENDANCE-MODES-PHASE-1.md`](./RADARCHAT-ATTENDANCE-MODES-PHASE-1.md). **Visão consolidada:** [`RADARCHAT-MODOS-ATENDIMENTO-IMPLEMENTACAO.md`](../RADARCHAT-MODOS-ATENDIMENTO-IMPLEMENTACAO.md).
...
- Tenants antigos com `mode: radarchat` → `attendanceMode: premium_assistant`.
...
| `premium_assistant` + Radar Chat | `radarchat` | `true` | Sim |
