# Radar Chat — Admin Dashboard Ops — Etapa 5 — Eventos de Segurança
...
| Etapa | Doc | Versão |
|-------|-----|--------|
| 1 Diagnóstico | [`RADARCHAT-ADMIN-DASHBOARD-OPS-DIAGNOSTICO.md`](./RADARCHAT-ADMIN-DASHBOARD-OPS-DIAGNOSTICO.md) | — |
| 2 Summary backend | [`RADARCHAT-ADMIN-DASHBOARD-OPS.md`](./RADARCHAT-ADMIN-DASHBOARD-OPS.md) | 2.12.37 |
| 3 Frontend dashboard | [`RADARCHAT-ADMIN-DASHBOARD-OPS-ETAPA-3-FRONTEND-DASHBOARD.md`](./RADARCHAT-ADMIN-DASHBOARD-OPS-ETAPA-3-FRONTEND-DASHBOARD.md) | 2.12.38 |
| 4 Empresas/trial | [`RADARCHAT-ADMIN-DASHBOARD-OPS-ETAPA-4-EMPRESAS-TRIAL.md`](./RADARCHAT-ADMIN-DASHBOARD-OPS-ETAPA-4-EMPRESAS-TRIAL.md) | 2.12.39 |
...
- Este doc, `RADARCHAT-ADMIN-DASHBOARD-OPS.md`, `CHANGELOG.md`, `SISTEMA-REGISTRO.md`, `INDICE-DOCUMENTACAO.md`
