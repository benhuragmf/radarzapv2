# Radar Chat — Admin Dashboard Ops — Etapa 6 — QA Final e Fechamento
...
| Item | Arquivo |
|------|---------|
| API técnica | [`RADARCHAT-ADMIN-DASHBOARD-OPS-API.md`](./RADARCHAT-ADMIN-DASHBOARD-OPS-API.md) |
| Checklist QA manual | [`RADARCHAT-ADMIN-DASHBOARD-OPS-QA-CHECKLIST.md`](./RADARCHAT-ADMIN-DASHBOARD-OPS-QA-CHECKLIST.md) |
| Resultado gates | [`RADARCHAT-ADMIN-DASHBOARD-OPS-QA-RESULTADO.md`](./RADARCHAT-ADMIN-DASHBOARD-OPS-QA-RESULTADO.md) |
| OpenAPI | `src/constants/openapi-dashboard.ts` — tag **Admin Ops** |
| Anti-segredo | `__tests__/admin-ops-anti-secret.test.ts` |
| Módulo atualizado | [`RADARCHAT-ADMIN-DASHBOARD-OPS.md`](./RADARCHAT-ADMIN-DASHBOARD-OPS.md) |
...
| # | Escopo | Doc |
|---|--------|-----|
| 1 | Diagnóstico | `RADARCHAT-ADMIN-DASHBOARD-OPS-DIAGNOSTICO.md` |
...
1. Benhur executar [`QA-CHECKLIST`](./RADARCHAT-ADMIN-DASHBOARD-OPS-QA-CHECKLIST.md)
