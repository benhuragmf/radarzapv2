# Radar Chat — Admin Dashboard Ops — Etapa 3 — Frontend Dashboard Operacional
...
- Doc: [`RADARCHAT-ADMIN-DASHBOARD-OPS-DIAGNOSTICO.md`](./RADARCHAT-ADMIN-DASHBOARD-OPS-DIAGNOSTICO.md)
...
- Listagem/ações trial por empresa → **Etapa 4** — [`RADARCHAT-ADMIN-DASHBOARD-OPS-ETAPA-4-EMPRESAS-TRIAL.md`](./RADARCHAT-ADMIN-DASHBOARD-OPS-ETAPA-4-EMPRESAS-TRIAL.md)
...
| Subtítulo | Saúde do sistema, empresas, trial, billing e operação Radar Chat |
...
| `docs/admin/RADARCHAT-ADMIN-DASHBOARD-OPS-ETAPA-3-FRONTEND-DASHBOARD.md` | Este doc |
| `docs/CHANGELOG.md` | § 2.12.38 |
| `docs/SISTEMA-REGISTRO.md` | Linha 2.12.38 |
| `docs/RADARCHAT-SISTEMA-COMPLETO.md` | Referência admin ops |
...
Spec de implementação: [`RADARCHAT-ADMIN-DASHBOARD-OPS-ETAPA-4-EMPRESAS-TRIAL.md`](./RADARCHAT-ADMIN-DASHBOARD-OPS-ETAPA-4-EMPRESAS-TRIAL.md)
