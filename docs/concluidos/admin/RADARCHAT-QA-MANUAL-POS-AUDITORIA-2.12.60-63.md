...
Ref: [`RADARCHAT-ADMIN-DASHBOARD-OPS-ETAPA-9-AUDITORIA-ROTAS.md`](./RADARCHAT-ADMIN-DASHBOARD-OPS-ETAPA-9-AUDITORIA-ROTAS.md)
...
| B3 | **Exportar JSON** | Download `.json` com `schema: radarchat-lgpd-export-v1` | ☐ |
...
| GitHub **CI** `main` @ `db077e0` | ✅ success — E2E 80/80 + test + audit ([run 28336722683](https://github.com/benhuragmf/radarchatv2/actions/runs/28336722683)) |
