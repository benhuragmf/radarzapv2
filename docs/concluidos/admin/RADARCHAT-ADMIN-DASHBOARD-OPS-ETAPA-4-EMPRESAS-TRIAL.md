# Radar Chat — Admin Dashboard Ops — Etapa 4 — Empresas, Trial e Plano
...
- 8 abas, cards, alertas — [`RADARCHAT-ADMIN-DASHBOARD-OPS-ETAPA-3-FRONTEND-DASHBOARD.md`](./RADARCHAT-ADMIN-DASHBOARD-OPS-ETAPA-3-FRONTEND-DASHBOARD.md) — `2.12.38`
...
| Arquivo doc | `docs/admin/RADARCHAT-ADMIN-DASHBOARD-OPS-ETAPA-4-EMPRESAS-TRIAL.md` |
...
Toda mutação chama `invalidateAdminOpsSummaryCache()` (Redis `radarchat:admin:ops:summary:v1`).
...
| Arquivo | Papel |
|---------|-------|
| `docs/admin/RADARCHAT-ADMIN-DASHBOARD-OPS-ETAPA-4-EMPRESAS-TRIAL.md` | **Este doc** |
