# RadarZap — TOP 17/20 — Billing, Assinaturas, Limites e Bloqueios
...
`docs/RADARZAP-SISTEMA-COMPLETO.md` §20, `CHANGELOG.md`, `INDICE-DOCUMENTACAO.md`, `SISTEMA-REGISTRO.md`, `IA-CREDITOS-E-CARTEIRA.md`, `radarzap-v2-system-registry.mdc`.
