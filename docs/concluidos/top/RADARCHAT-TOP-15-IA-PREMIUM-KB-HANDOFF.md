# Radar Chat — TOP 15/20 — IA Premium, Base de Conhecimento e Handoff
...
`RADARCHAT-SISTEMA-COMPLETO.md` §18 atualizada.
...
| Provider | Sim | `AiProviderService.ts` | OpenAI/Gemini/Radar Chat/company |
...
| Aspecto | Estado |
|---------|--------|
| Providers | OpenAI, Google Gemini, credencial Radar Chat (`mode: radarchat`), empresa (`mode: company`) |
...
- `RADARCHAT-SISTEMA-COMPLETO.md` §18
- `README.md`, `INDICE-DOCUMENTACAO.md`, `CHANGELOG.md`, `SISTEMA-REGISTRO.md`, `.cursor/rules/radarchat-v2-system-registry.mdc` → `2.12.1`
...
- `package.json`
- `docs/top/RADARCHAT-TOP-15-IA-PREMIUM-KB-HANDOFF.md` (novo)
- `docs/RADARCHAT-SISTEMA-COMPLETO.md`
- `docs/CHANGELOG.md`, `docs/INDICE-DOCUMENTACAO.md`, `docs/SISTEMA-REGISTRO.md`
- `README.md`, `.cursor/rules/radarchat-v2-system-registry.mdc`
