# RadarZap — TOP 03/20 — Planos, Mensalidades, Limites e Matriz Comercial
...
O TOP 03 formalizou a **matriz comercial oficial** do RadarZap em `config/plans.json`, com validação automática, tipos TypeScript e leitura unificada de limites operacionais e IA Créditos. Cinco planos de lançamento: **trial, free, starter, pro, enterprise**.
...
docs/top/RADARZAP-TOP-03-PLANOS-MENSALIDADES-LIMITES.md
package.json
README.md
