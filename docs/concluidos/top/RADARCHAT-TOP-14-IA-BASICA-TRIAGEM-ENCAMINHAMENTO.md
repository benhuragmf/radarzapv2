# Radar Chat — TOP 14/20 — IA Básica, Triagem e Encaminhamento
...
`RADARCHAT-SISTEMA-COMPLETO.md` §17 atualizada.
...
`RADARCHAT-SISTEMA-COMPLETO.md` §17, README, INDICE, CHANGELOG, SISTEMA-REGISTRO → `2.12.0`.
