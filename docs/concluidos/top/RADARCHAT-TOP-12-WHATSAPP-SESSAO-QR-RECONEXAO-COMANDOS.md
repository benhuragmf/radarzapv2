# Radar Chat — TOP 12/20 — WhatsApp, Sessão, QR, Reconexão e Comandos
...
`docs/RADARCHAT-SISTEMA-COMPLETO.md` **não existia** antes do TOP 12 — criado nesta etapa. README e índice atualizados.
...
| Arquivo | Status | Ação |
|---------|--------|------|
| `docs/RADARCHAT-SISTEMA-COMPLETO.md` | **criado** | documentação principal |
...
| `.cursor/rules/radarchat-v2-system-registry.mdc` | atualizado | espelho |
...
- `docs/top/RADARCHAT-TOP-12-WHATSAPP-SESSAO-QR-RECONEXAO-COMANDOS.md` (novo)
- `docs/RADARCHAT-SISTEMA-COMPLETO.md` (novo)
