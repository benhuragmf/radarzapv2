# Radar Chat — TOP 13/20 — Bridge WebChat ↔ WhatsApp
...
`RADARCHAT-SISTEMA-COMPLETO.md` criada no TOP 12 — §16 atualizada neste TOP.
...
- `docs/RADARCHAT-SISTEMA-COMPLETO.md` §16 expandida.
...
- `docs/top/RADARCHAT-TOP-13-BRIDGE-WEBCHAT-WHATSAPP.md` (novo)
- `docs/RADARCHAT-SISTEMA-COMPLETO.md`
- `docs/INDICE-DOCUMENTACAO.md`, `CHANGELOG.md`, `SISTEMA-REGISTRO.md`
- `README.md`, `package.json`, `.cursor/rules/radarchat-v2-system-registry.mdc`
