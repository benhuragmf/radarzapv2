# Radar Chat — TOP 21 Extra — Documentação Final Única e Organização Pós-TOP20
...
**Fonte oficial para status, checklists, pendências e go-live:** [`RADARCHAT-TOP-20-CONGELAMENTO-FINAL-GO-LIVE-CONTROLADO.md`](./RADARCHAT-TOP-20-CONGELAMENTO-FINAL-GO-LIVE-CONTROLADO.md).
...
O TOP 21 **não redefine** status nem checklists — espelha o [TOP 20](./RADARCHAT-TOP-20-CONGELAMENTO-FINAL-GO-LIVE-CONTROLADO.md):
...
|-----------|--------------|-------------|
| [`RADARCHAT-TOP-20-CONGELAMENTO-FINAL-GO-LIVE-CONTROLADO.md`](./RADARCHAT-TOP-20-CONGELAMENTO-FINAL-GO-LIVE-CONTROLADO.md) | Fonte oficial TOP 20 | **Referência obrigatória** — status, checklists, pendências |
| `RADARCHAT-SISTEMA-COMPLETO.md` | Topo `2.12.4` (histórico); bridge ambígua | `2.12.6`, status TOP 20, WA/Bridge = QA real |
...
| `RADARCHAT-RESULTADO-FINAL-TOP-01-20.md` | OK `2.12.6` | Preservado |
...
1. `RADARCHAT-SISTEMA-COMPLETO.md` — versão `2.12.6`, status TOP 20 completo, §15/§16/§25 WA e Bridge (código fechado; QA real pendente), link TOP 20.
...
| Papel | Arquivo |
|-------|---------|
| **Mestre (leia primeiro)** | `docs/RADARCHAT-SISTEMA-COMPLETO.md` |
| **Resumo executivo** | `docs/concluidos/RADARCHAT-RESULTADO-FINAL-TOP-01-20.md` |
...
Os arquivos em `docs/top/RADARCHAT-TOP-NN-*.md` são **histórico de auditoria** e **prova do que foi executado** no fechamento TOP 01–20.
...
4. **Resumir** em `RADARCHAT-SISTEMA-COMPLETO.md` §24 e `RADARCHAT-RESULTADO-FINAL-TOP-01-20.md`.
...
|-----|---------|-------------|--------|
| 01 | `RADARCHAT-TOP-01-DIAGNOSTICO-INICIAL.md` | Preservar em `docs/top/` | ✅ Existe |
| 02 | `RADARCHAT-TOP-02-GOVERNANCA-BASELINE-GATES.md` | Preservar em `docs/top/` | ✅ Existe |
| 03 | `RADARCHAT-TOP-03-PLANOS-MENSALIDADES-LIMITES.md` | Preservar em `docs/top/` | ✅ Existe |
| 04 | `RADARCHAT-TOP-04-RBAC-PERMISSOES-EQUIPE-SEGURANCA.md` | Preservar em `docs/top/` | ✅ Existe |
| 05 | `RADARCHAT-TOP-05-STATUS-PRESENCA-FILA.md` | Preservar em `docs/top/` | ✅ Existe |
| 06 | `RADARCHAT-TOP-06-MODOS-ATENDIMENTO.md` | Preservar em `docs/top/` | ✅ Existe |
| 07 | `RADARCHAT-TOP-07-INBOX-CONVERSAS-FILA-TRANSFERENCIA.md` | Preservar em `docs/top/` | ✅ Existe |
| 08 | `RADARCHAT-TOP-08-TICKETS-CHAMADOS-TK-RASTREABILIDADE.md` | Preservar em `docs/top/` | ✅ Existe |
| 09 | `RADARCHAT-TOP-09-CONTATOS-LEADS-KANBAN-DEDUPLICACAO.md` | Preservar em `docs/top/` | ✅ Existe |
| 10 | `RADARCHAT-TOP-10-FORMULARIOS-PUBLICOS-EMBED-CAPTURA-LEADS.md` | Preservar em `docs/top/` | ✅ Existe |
| 11 | `RADARCHAT-TOP-11-WEBCHAT-WIDGET-FALLBACK-EXPERIENCIA.md` | Preservar em `docs/top/` | ✅ Existe |
| 12 | `RADARCHAT-TOP-12-WHATSAPP-SESSAO-QR-RECONEXAO-COMANDOS.md` | Preservar em `docs/top/` | ✅ Existe |
| 13 | `RADARCHAT-TOP-13-BRIDGE-WEBCHAT-WHATSAPP.md` | Preservar em `docs/top/` | ✅ Existe |
| 14 | `RADARCHAT-TOP-14-IA-BASICA-TRIAGEM-ENCAMINHAMENTO.md` | Preservar em `docs/top/` | ✅ Existe |
| 15 | `RADARCHAT-TOP-15-IA-PREMIUM-KB-HANDOFF.md` | Preservar em `docs/top/` | ✅ Existe |
| 16 | `RADARCHAT-TOP-16-IA-CREDITOS-CARTEIRA-CONSUMO-FALLBACK.md` | Preservar em `docs/top/` | ✅ Existe |
| 17 | `RADARCHAT-TOP-17-BILLING-ASSINATURAS-LIMITES-BLOQUEIOS.md` | Preservar em `docs/top/` | ✅ Existe |
| 18 | `RADARCHAT-TOP-18-AUDITORIA-SEGURANCA-LGPD-HARDENING.md` | Preservar em `docs/top/` | ✅ Existe |
| 19 | `RADARCHAT-TOP-19-QA-FINAL-REGRESSAO-GO-LIVE.md` | Preservar em `docs/top/` | ✅ Existe |
| 20 | `RADARCHAT-TOP-20-CONGELAMENTO-FINAL-GO-LIVE-CONTROLADO.md` | Preservar em `docs/top/` | ✅ Existe |
| 21 | `RADARCHAT-TOP-21-DOCUMENTACAO-FINAL-UNICA-ORGANIZACAO.md` | Extra pós-TOP20 | ✅ Este doc |
...
|-----------|------------------|--------|
| `concluidos/RADARCHAT-ATTENDANCE-MODES-PHASE-*.md` | Preservar em `concluidos/` | Histórico fases; consolidado em modos |
...
| `RADARCHAT-VISAO-PRODUTO-DIFERENCIACAO.md` | Preservar | Pós-estabilização |
...
```txt
docs/top/RADARCHAT-TOP-01-*.md
docs/top/RADARCHAT-TOP-02-*.md
… (TOP 03–19) …
docs/top/RADARCHAT-TOP-20-*.md
docs/top/RADARCHAT-TOP-21-*.md
```
...
```txt
docs/RADARCHAT-SISTEMA-COMPLETO.md
docs/concluidos/RADARCHAT-RESULTADO-FINAL-TOP-01-20.md
docs/top/RADARCHAT-TOP-20-CONGELAMENTO-FINAL-GO-LIVE-CONTROLADO.md
...
- `docs/top/RADARCHAT-TOP-21-DOCUMENTACAO-FINAL-UNICA-ORGANIZACAO.md` (novo)
- `docs/RADARCHAT-SISTEMA-COMPLETO.md`
- `docs/INDICE-DOCUMENTACAO.md`
- `docs/CHANGELOG.md`
- `docs/SISTEMA-REGISTRO.md`
...
**Preservados sem edição:** `RADARCHAT-RESULTADO-FINAL-TOP-01-20.md`, `QA-FASE1-RESULTADO-TEMPLATE.md` (já corretos).
