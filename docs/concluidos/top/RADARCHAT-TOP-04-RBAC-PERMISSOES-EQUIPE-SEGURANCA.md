# Radar Chat — TOP 04/20 — RBAC, Permissões, Equipe e Segurança Multiempresa
...
O TOP 04 fechou a **base de segurança operacional** do Radar Chat: matriz oficial de cargos/permissões documentada, presets existentes validados por testes, **limites de equipe por plano** aplicados no fluxo de convite/alteração de cargo, auditoria mínima em ações de equipe e testes RBAC/cross-tenant.
...
- `docs/top/RADARCHAT-TOP-04-RBAC-PERMISSOES-EQUIPE-SEGURANCA.md` (novo)
- `docs/EQUIPE-RBAC.md`
- `docs/CHANGELOG.md`
