# Radar Chat — TOP 08/20 — Tickets, Chamados, TK e Rastreabilidade
...
O TOP 08 consolidou o módulo **Tickets/Chamados** já existente no Radar Chat v2: protocolo `TK-XXXXXX`, token público com hash SHA-256, janela de resposta do cliente (12h), SLA operacional de equipe (24h após resposta do cliente), vínculo com Inbox/WebChat/WhatsApp, consulta pública segura, helpers centralizados de status/SLA e auditoria ampliada (`ticket.reopened`, `ticket.assigned`).
...
- `docs/top/RADARCHAT-TOP-08-TICKETS-CHAMADOS-TK-RASTREABILIDADE.md` (novo)
