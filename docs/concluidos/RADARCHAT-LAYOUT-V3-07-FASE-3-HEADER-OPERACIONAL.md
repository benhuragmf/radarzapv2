...
> **Arquivo — entrega Layout v3 Fase 3.** Referência viva: [`DESIGN-SYSTEM.md`](../DESIGN-SYSTEM.md), [`RADARCHAT-LAYOUT-V3-09`](../RADARCHAT-LAYOUT-V3-09-FASE-4-5-QA-VISUAL-NAVEGAVEL.md).
...
| Tipo | Arquivos |
|------|----------|
| Docs Layout v3 | `RADARCHAT-LAYOUT-V3-02`, `03`, `04`, `06` |
...
2. `docs/RADARCHAT-LAYOUT-V3-07-FASE-3-HEADER-OPERACIONAL.md`
