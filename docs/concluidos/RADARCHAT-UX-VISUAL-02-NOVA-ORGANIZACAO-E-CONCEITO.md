# Radar Chat UX Visual 02 — Nova Organização e Conceito

> **Arquivo — planejamento Layout v3.** Substituído pelas fases de execução [`RADARCHAT-LAYOUT-V3-06`](../RADARCHAT-LAYOUT-V3-06-FASE-2-MENU-E-NAVEGACAO.md) … [`09`](../RADARCHAT-LAYOUT-V3-09-FASE-4-5-QA-VISUAL-NAVEGAVEL.md).

## 1. Princípio central

O Radar Chat deve parecer um painel de controle de atendimento e relacionamento, onde o dono entende a empresa em poucos segundos, o funcionário atende sem se perder e o cliente final sabe exatamente onde está no atendimento.
...
| Dono/desenvolvedor Radar Chat | Mapa estável de rotas, componentes, permissões, QA, riscos e evolução | Refatoração visual sem inventário | Melhorar UI e quebrar RBAC/fluxo | Plano por fases com checklist, docs e QA antes de cada mudança |
...
Fica na aba Admin para staff Radar Chat:
...
| Admin Dashboard | Painel Admin Radar Chat | Separar de dashboard tenant |
