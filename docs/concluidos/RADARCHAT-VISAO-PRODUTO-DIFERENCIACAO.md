# Radar Chat — Visão de produto e diferenciação
...
> **Radar Chat é uma central inteligente de atendimento e vendas para sites brasileiros, unindo chat online, WhatsApp, IA e acompanhamento de chamados em um único painel.**
...
**Plano de execução:** [`RADARCHAT-PLANO-UPGRADES.md`](./RADARCHAT-PLANO-UPGRADES.md) — 21 épicos priorizados com checklists completos.
...
**Já parcialmente no Radar Chat:** WebChat, bridge WA, ticket, pré-chat, FAQ/IA, painel Inbox 3 colunas.
...
Chatbot genérico = commodity. **Central de conversão para pequenos negócios brasileiros** = posicionamento Radar Chat.
