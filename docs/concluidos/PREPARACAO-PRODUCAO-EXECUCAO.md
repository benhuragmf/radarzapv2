...
> **Arquivo (2026-06-29).** Tracker da migração Coolify + branch `layout-v3` @ `2.12.71`. **Produção atual:** `main` / `2.17.61` via Coolify — ver [`COOLIFY-DEPLOY.md`](../COOLIFY-DEPLOY.md). Prep ativa: [`PREPARACAO-PRODUCAO.md`](../PREPARACAO-PRODUCAO.md).
...
- Merge `layout-v3` → `main` só após Codex + `pre-push:gate` + QA visual ([`RADARCHAT-LAYOUT-V3-09`](./RADARCHAT-LAYOUT-V3-09-FASE-4-5-QA-VISUAL-NAVEGAVEL.md)).
...
1. **Codex:** continuar Layout v3 — fases ativas [`06`](./RADARCHAT-LAYOUT-V3-06-FASE-2-MENU-E-NAVEGACAO.md)–[`09`](./RADARCHAT-LAYOUT-V3-09-FASE-4-5-QA-VISUAL-NAVEGAVEL.md); planejamento em [`concluidos/RADARCHAT-LAYOUT-V3-05`](./concluidos/RADARCHAT-LAYOUT-V3-05-PROXIMAS-FASES-E-PROMPTS.md) (arquivo).
...
- Layout v3 execução: [`RADARCHAT-LAYOUT-V3-06`](./RADARCHAT-LAYOUT-V3-06-FASE-2-MENU-E-NAVEGACAO.md) … [`09`](./RADARCHAT-LAYOUT-V3-09-FASE-4-5-QA-VISUAL-NAVEGAVEL.md)
- QA visual layout: [`RADARCHAT-LAYOUT-V3-09-FASE-4-5-QA-VISUAL-NAVEGAVEL.md`](./RADARCHAT-LAYOUT-V3-09-FASE-4-5-QA-VISUAL-NAVEGAVEL.md)
