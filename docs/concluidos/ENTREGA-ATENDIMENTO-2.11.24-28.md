...
| **2.11.28** | `WebChatBasicTriageService` não cai no menu robotizado | `RADARCHAT-MODOS-ATENDIMENTO-IMPLEMENTACAO.md` |
...
- [`RADARCHAT-MODOS-ATENDIMENTO-IMPLEMENTACAO.md`](../RADARCHAT-MODOS-ATENDIMENTO-IMPLEMENTACAO.md)
- [`concluidos/RADARCHAT_WHATSAPP_TICKET_FAQ_IMPLEMENTATION.md`](./RADARCHAT_WHATSAPP_TICKET_FAQ_IMPLEMENTATION.md)
