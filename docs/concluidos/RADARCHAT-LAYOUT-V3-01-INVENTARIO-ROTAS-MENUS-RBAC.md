...
> **Arquivo — pré-implementação Layout v3.** Referência viva: [`MENU-PAGES-REGISTRY.md`](../MENU-PAGES-REGISTRY.md), [`MENUS-SISTEMA.md`](../MENUS-SISTEMA.md). Execução: fases [`06`](../RADARCHAT-LAYOUT-V3-06-FASE-2-MENU-E-NAVEGACAO.md)–[`09`](../RADARCHAT-LAYOUT-V3-09-FASE-4-5-QA-VISUAL-NAVEGAVEL.md).
