...
- [x] `npm test` + `npm run qa:atendimento:gate` verdes — validado **2026-06-22** (476 testes; gate 117+53; `qa:prep` OK)
...
| **Média** | Integração `tryHandleCsatReply` + ordem inbound | **Parcial** — `inbox-csat-reply.integration.test.ts` (2.11.30); ticket/IA inbound ainda sem integração |
