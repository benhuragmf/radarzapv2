...
> **Versão ref:** `2.17.61` · **Última revisão:** 2026-07-01  
> **Tracker histórico:** [`concluidos/PREPARACAO-PRODUCAO-EXECUCAO.md`](../concluidos/PREPARACAO-PRODUCAO-EXECUCAO.md)  
> **Produção:** `main` @ `2.17.61` via Coolify — ver [`COOLIFY-DEPLOY.md`](../COOLIFY-DEPLOY.md).  
...
| **`COOLIFY-DEPLOY.md`** | Deploy Docker Compose no Coolify (`main` @ `2.17.61`) |
| **`concluidos/PREPARACAO-PRODUCAO-EXECUCAO.md`** | Tracker histórico — migração Coolify `2.12.71` |
...
| `docs/security/SECURITY_CHECKLIST.md` | Resumo de segurança (detalhes aqui § Checkup) |
...
**Prep infra:** ver [`COOLIFY-DEPLOY.md`](../COOLIFY-DEPLOY.md) (produção @ `2.17.61`). Tracker jun/2026 arquivado em [`concluidos/PREPARACAO-PRODUCAO-EXECUCAO.md`](../concluidos/PREPARACAO-PRODUCAO-EXECUCAO.md).
...
Docs: `SECURITY.md`, `docs/concluidos/SECURITY_AUDIT.md`, `docs/security/SECURITY_CHECKLIST.md`.
