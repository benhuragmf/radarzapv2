...
| **Manual celular + WA** | [`RADARCHAT-QA-HUMANO-REAL-CHECKLIST-COMPLETO-2.17.61.md`](../RADARCHAT-QA-HUMANO-REAL-CHECKLIST-COMPLETO-2.17.61.md) | Mensagens reais, CSAT, bridge | **Obrigatório** para fechar gate |
...
3. [`RADARCHAT-QA-HUMANO-REAL-CHECKLIST-COMPLETO-2.17.61.md`](../RADARCHAT-QA-HUMANO-REAL-CHECKLIST-COMPLETO-2.17.61.md) → manual celular (~2 h)
```
...
- [`concluidos/QA-FASE1-KICKOFF.md`](../concluidos/QA-FASE1-KICKOFF.md) (arquivo)
