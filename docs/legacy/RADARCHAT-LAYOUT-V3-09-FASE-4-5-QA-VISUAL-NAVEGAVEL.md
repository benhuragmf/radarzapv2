...
> **Referência Layout v3 (arquivo parcial @ `2.12.71`).** Produção atual: `2.17.61` — menus/DS vivos: [`MENUS-SISTEMA.md`](../MENUS-SISTEMA.md), [`DESIGN-SYSTEM.md`](../DESIGN-SYSTEM.md).
...
| Grupo | Arquivos |
|-------|----------|
| Processo Layout v3 | `concluidos/RADARCHAT-LAYOUT-V3-06-FASE-2-MENU-E-NAVEGACAO.md`, `RADARCHAT-LAYOUT-V3-07-FASE-3-HEADER-OPERACIONAL.md`, `RADARCHAT-LAYOUT-V3-08-FASE-4-COMPONENTES-VISUAIS-COMPARTILHADOS.md`, `concluidos/RADARCHAT-LAYOUT-V3-04-CHECKLIST-QA-VISUAL-E-FUNCIONAL.md` (arquivo) |
