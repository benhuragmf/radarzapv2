...
| Grupo | Arquivos |
|-------|----------|
| Processo Layout v3 | `RADARZAP-LAYOUT-V3-06-FASE-2-MENU-E-NAVEGACAO.md`, `RADARZAP-LAYOUT-V3-07-FASE-3-HEADER-OPERACIONAL.md`, `RADARZAP-LAYOUT-V3-08-FASE-4-COMPONENTES-VISUAIS-COMPARTILHADOS.md`, `RADARZAP-LAYOUT-V3-04-CHECKLIST-QA-VISUAL-E-FUNCIONAL.md` |
...
|-------------|----------|--------|-----------|
| `/` login | 1366x768 | Aprovado | H1 e title exibem `Radar Chat`; sem `RadarZap`; `scrollWidth=1366` |
...
|----|------------|----------|--------|
| P4.5-01 | P2 | Titulo HTML do app ainda dizia `RadarZap` | Corrigido |
| P4.5-02 | P2 | Manifest PWA ainda dizia `RadarZap` | Corrigido |
...
| P4.5-05 | P2 | Footer do formulario de leads apontava para `radarzap.com.br` | Corrigido para `radarchat.com.br` |
...
- Identificadores tecnicos `radarzap` quando fazem parte de contrato, storage, volumes, env vars, package scopes ou historico.

## 9. RBAC e seguranca

| Item | Status |
|------|--------|
| `X-RadarZap-Signature` | Preservado como header de contrato dos webhooks |
| `RADARZAP_SYSTEM_ADMIN_DISCORD_IDS` | Preservado como env var tecnica |
| Volumes `radarzap-*` | Preservados para nao quebrar dados persistentes |
