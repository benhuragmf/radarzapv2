...
**Recomendações:** contrato de licença (já em LICENSE.md), telemetria opcional de instalação, watermark em builds enterprise — ver `SECURITY_RECOMMENDATIONS.md`.
...
*Próximo passo: [SECURITY_FIX_PLAN.md](SECURITY_FIX_PLAN.md)*
